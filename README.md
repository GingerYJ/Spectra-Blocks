...
### gradle.properties
Edit gradle.properties and set your spectrablocks, mod version, mod name, package, etc.
...
### Mixin
1. Rename json config file to include your spectrablocks. You will need one json per phase (`PRE_INIT`, `DEFAULT`, `MOD`) 
...
Rename AT file name to your spectrablocks before using it. There's an example entry in AT file, remove it if you want to use AT.
