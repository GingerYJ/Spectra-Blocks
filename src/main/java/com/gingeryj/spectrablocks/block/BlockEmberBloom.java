...
public class BlockEmberBloom extends Block {
    ...
    public BlockEmberBloom() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "ember_bloom");
        setTranslationKey(Reference.MOD_ID + ".ember_bloom");
        setHardness(-1.0F);
