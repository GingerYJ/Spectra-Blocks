...
public class BlockTemporalRift extends Block {
    ...
    public BlockTemporalRift() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "temporal_rift");
        setTranslationKey(Reference.MOD_ID + ".temporal_rift");
        setHardness(-1.0F);
