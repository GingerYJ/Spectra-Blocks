...
public class BlockCrystalHarmonicResonator extends Block {
    ...
    public BlockCrystalHarmonicResonator() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "crystal_harmonic_resonator");
        setTranslationKey(Reference.MOD_ID + ".crystal_harmonic_resonator");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileCrystalHarmonicResonator();
    }
