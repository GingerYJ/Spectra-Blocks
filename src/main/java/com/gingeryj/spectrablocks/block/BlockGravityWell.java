...
public class BlockGravityWell extends Block {
    ...
    public BlockGravityWell() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "gravity_well");
        setTranslationKey(Reference.MOD_ID + ".gravity_well");
        setHardness(-1.0F);
