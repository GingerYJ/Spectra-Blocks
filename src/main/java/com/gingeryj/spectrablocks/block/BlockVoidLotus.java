...
public class BlockVoidLotus extends Block {
    ...
    public BlockVoidLotus() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "void_lotus");
        setTranslationKey(Reference.MOD_ID + ".void_lotus");
        setHardness(-1.0F);
