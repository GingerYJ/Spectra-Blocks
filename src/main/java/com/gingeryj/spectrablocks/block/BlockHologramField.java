...
public class BlockHologramField extends Block {
    ...
    public BlockHologramField() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "hologram_field");
        setTranslationKey(Reference.MOD_ID + ".hologram_field");
        setHardness(-1.0F);
