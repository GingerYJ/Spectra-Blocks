...
public class BlockMicroUniverse extends Block {
    ...
    public BlockMicroUniverse() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "micro_universe");
        setTranslationKey(Reference.MOD_ID + ".micro_universe");
        setHardness(-1.0F);
