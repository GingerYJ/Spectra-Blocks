...
public class BlockEchoingVoidBell extends Block {
    ...
    public BlockEchoingVoidBell() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "echoing_void_bell");
        setTranslationKey(Reference.MOD_ID + ".echoing_void_bell");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEchoingVoidBell();
    }
