...
public class BlockPhantomEye extends Block {
    ...
    public BlockPhantomEye() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "phantom_eye");
        setTranslationKey(Reference.MOD_ID + ".phantom_eye");
        setHardness(-1.0F);
