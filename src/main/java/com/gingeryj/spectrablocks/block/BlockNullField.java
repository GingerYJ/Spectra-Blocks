...
public class BlockNullField extends Block {
    ...
    public BlockNullField() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "null_field");
        setTranslationKey(Reference.MOD_ID + ".null_field");
        setHardness(-1.0F);
