...
public class BlockSpatialRift extends Block {
    ...
    public BlockSpatialRift() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "spatial_rift");
        setTranslationKey(Reference.MOD_ID + ".spatial_rift");
        setHardness(-1.0F);
