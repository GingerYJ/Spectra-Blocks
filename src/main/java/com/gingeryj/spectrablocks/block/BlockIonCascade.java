...
public class BlockIonCascade extends Block {
    ...
    public BlockIonCascade() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "ion_cascade");
        setTranslationKey(Reference.MOD_ID + ".ion_cascade");
        setHardness(-1.0F);
