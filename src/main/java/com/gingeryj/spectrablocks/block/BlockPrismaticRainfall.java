...
public class BlockPrismaticRainfall extends Block {
    ...
    public BlockPrismaticRainfall() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "prismatic_rainfall");
        setTranslationKey(Reference.MOD_ID + ".prismatic_rainfall");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TilePrismaticRainfall();
    }
