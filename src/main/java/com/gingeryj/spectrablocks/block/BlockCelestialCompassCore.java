...
public class BlockCelestialCompassCore extends Block {
    ...
    public BlockCelestialCompassCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "celestial_compass_core");
        setTranslationKey(Reference.MOD_ID + ".celestial_compass_core");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileCelestialCompassCore();
    }
