...
public class BlockSolarCoronaBurst extends Block {
    ...
    public BlockSolarCoronaBurst() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "solar_corona_burst");
        setTranslationKey(Reference.MOD_ID + ".solar_corona_burst");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileSolarCoronaBurst();
    }
