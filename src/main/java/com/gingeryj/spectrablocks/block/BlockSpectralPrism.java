...
public class BlockSpectralPrism extends Block {
    ...
    public BlockSpectralPrism() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "spectral_prism");
        setTranslationKey(Reference.MOD_ID + ".spectral_prism");
        setHardness(-1.0F);
