...
public class BlockCrystalRefractionField extends Block {
    ...
    public BlockCrystalRefractionField() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "crystal_refraction_field");
        setTranslationKey(Reference.MOD_ID + ".crystal_refraction_field");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileCrystalRefractionField();
    }
