...
public class BlockRuneObelisk extends Block {
    ...
    public BlockRuneObelisk() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "rune_obelisk");
        setTranslationKey(Reference.MOD_ID + ".rune_obelisk");
        setHardness(-1.0F);
