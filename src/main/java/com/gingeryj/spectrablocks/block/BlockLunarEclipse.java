...
public class BlockLunarEclipse extends Block {
    ...
    public BlockLunarEclipse() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "lunar_eclipse");
        setTranslationKey(Reference.MOD_ID + ".lunar_eclipse");
        setHardness(-1.0F);
