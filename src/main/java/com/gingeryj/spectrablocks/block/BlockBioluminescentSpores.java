...
public class BlockBioluminescentSpores extends Block {
    ...
    public BlockBioluminescentSpores() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "bioluminescent_spores");
        setTranslationKey(Reference.MOD_ID + ".bioluminescent_spores");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileBioluminescentSpores();
    }
