...
public class BlockNovaBloom extends Block {
    ...
    public BlockNovaBloom() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "nova_bloom");
        setTranslationKey(Reference.MOD_ID + ".nova_bloom");
        setHardness(-1.0F);
