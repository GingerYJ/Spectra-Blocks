...
public class BlockQuantumBubble extends Block {
    ...
    public BlockQuantumBubble() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "quantum_bubble");
        setTranslationKey(Reference.MOD_ID + ".quantum_bubble");
        setHardness(-1.0F);
