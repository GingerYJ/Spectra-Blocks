...
public class BlockTectonicFaultCore extends Block {
    ...
    public BlockTectonicFaultCore() {
        super(Material.ROCK);
        setRegistryName(Reference.MOD_ID, "tectonic_fault_core");
        setTranslationKey(Reference.MOD_ID + ".tectonic_fault_core");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileTectonicFaultCore();
    }
