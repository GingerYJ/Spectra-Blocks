...
public class BlockCollapsingStar extends Block {
    ...
    public BlockCollapsingStar() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "collapsing_star");
        setTranslationKey(Reference.MOD_ID + ".collapsing_star");
        setHardness(-1.0F);
