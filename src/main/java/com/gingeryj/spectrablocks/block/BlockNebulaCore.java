...
public class BlockNebulaCore extends Block {
    ...
    public BlockNebulaCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "nebula_core");
        setTranslationKey(Reference.MOD_ID + ".nebula_core");
        setHardness(-1.0F);
