...
public class BlockRiftAnchorSpire extends Block {
    ...
    public BlockRiftAnchorSpire() {
        super(Material.ROCK);
        setRegistryName(Reference.MOD_ID, "rift_anchor_spire");
        setTranslationKey(Reference.MOD_ID + ".rift_anchor_spire");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileRiftAnchorSpire();
    }
