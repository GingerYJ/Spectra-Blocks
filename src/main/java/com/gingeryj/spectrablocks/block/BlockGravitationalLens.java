...
public class BlockGravitationalLens extends Block {
    ...
    public BlockGravitationalLens() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "gravitational_lens");
        setTranslationKey(Reference.MOD_ID + ".gravitational_lens");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileGravitationalLens();
    }
