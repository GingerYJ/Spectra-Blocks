...
public class BlockNeonCircuitCore extends Block {
    ...
    public BlockNeonCircuitCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "neon_circuit_core");
        setTranslationKey(Reference.MOD_ID + ".neon_circuit_core");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileNeonCircuitCore();
    }
