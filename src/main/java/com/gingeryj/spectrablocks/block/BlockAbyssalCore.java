...
public class BlockAbyssalCore extends Block {
    ...
    public BlockAbyssalCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "abyssal_core");
        setTranslationKey(Reference.MOD_ID + ".abyssal_core");
        setHardness(-1.0F);
