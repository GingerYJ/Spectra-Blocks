...
public class BlockFlameHeart extends Block {
    ...
    public BlockFlameHeart() {
        super(Material.FIRE);
        setRegistryName(Reference.MOD_ID, "flame_heart");
        setTranslationKey(Reference.MOD_ID + ".flame_heart");
        setHardness(-1.0F);
