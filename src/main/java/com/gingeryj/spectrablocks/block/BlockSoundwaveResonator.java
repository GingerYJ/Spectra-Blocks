...
public class BlockSoundwaveResonator extends Block {
    ...
    public BlockSoundwaveResonator() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "soundwave_resonator");
        setTranslationKey(Reference.MOD_ID + ".soundwave_resonator");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileSoundwaveResonator();
    }
