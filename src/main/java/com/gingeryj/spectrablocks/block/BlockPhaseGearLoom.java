...
public class BlockPhaseGearLoom extends Block {
    ...
    public BlockPhaseGearLoom() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "phase_gear_loom");
        setTranslationKey(Reference.MOD_ID + ".phase_gear_loom");
        setHardness(-1.0F);
