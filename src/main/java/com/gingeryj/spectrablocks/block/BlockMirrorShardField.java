...
public class BlockMirrorShardField extends Block {
    ...
    public BlockMirrorShardField() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "mirror_shard_field");
        setTranslationKey(Reference.MOD_ID + ".mirror_shard_field");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileMirrorShardField();
    }
