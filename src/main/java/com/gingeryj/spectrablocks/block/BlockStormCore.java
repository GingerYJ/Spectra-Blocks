...
public class BlockStormCore extends Block {
    ...
    public BlockStormCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "storm_core");
        setTranslationKey(Reference.MOD_ID + ".storm_core");
        setHardness(-1.0F);
