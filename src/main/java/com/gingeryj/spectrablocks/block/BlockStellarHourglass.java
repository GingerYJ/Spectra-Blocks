...
public class BlockStellarHourglass extends Block {
    ...
    public BlockStellarHourglass() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "stellar_hourglass");
        setTranslationKey(Reference.MOD_ID + ".stellar_hourglass");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileStellarHourglass();
    }
