...
public class BlockSingularityLattice extends Block {
    ...
    public BlockSingularityLattice() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "singularity_lattice");
        setTranslationKey(Reference.MOD_ID + ".singularity_lattice");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileSingularityLattice();
    }
