...
public class BlockHexBarrier extends Block {
    ...
    public BlockHexBarrier() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "hex_barrier");
        setTranslationKey(Reference.MOD_ID + ".hex_barrier");
        setHardness(-1.0F);
