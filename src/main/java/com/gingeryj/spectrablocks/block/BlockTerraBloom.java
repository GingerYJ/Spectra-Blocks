...
public class BlockTerraBloom extends Block {
    ...
    public BlockTerraBloom() {
        super(Material.PLANTS);
        setRegistryName(Reference.MOD_ID, "terra_bloom");
        setTranslationKey(Reference.MOD_ID + ".terra_bloom");
        setHardness(-1.0F);
