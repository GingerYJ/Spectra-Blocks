...
public class BlockInkMirageBasin extends Block {
    ...
    public BlockInkMirageBasin() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "ink_mirage_basin");
        setTranslationKey(Reference.MOD_ID + ".ink_mirage_basin");
        setHardness(-1.0F);
