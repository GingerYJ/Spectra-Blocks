...
public class BlockEntropyCloud extends Block {
    ...
    public BlockEntropyCloud() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "entropy_cloud");
        setTranslationKey(Reference.MOD_ID + ".entropy_cloud");
        setHardness(-1.0F);
