...
public class BlockAuroraVeil extends Block {
    ...
    public BlockAuroraVeil() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "aurora_veil");
        setTranslationKey(Reference.MOD_ID + ".aurora_veil");
        setHardness(-1.0F);
