...
public class BlockThermalDistortionField extends Block {
    ...
    public BlockThermalDistortionField() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "thermal_distortion_field");
        setTranslationKey(Reference.MOD_ID + ".thermal_distortion_field");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileThermalDistortionField();
    }
