...
public class BlockSpectralHourglassGate extends Block {
    ...
    public BlockSpectralHourglassGate() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "spectral_hourglass_gate");
        setTranslationKey(Reference.MOD_ID + ".spectral_hourglass_gate");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileSpectralHourglassGate();
    }
