...
public class BlockShieldDome extends Block {
    ...
    public BlockShieldDome() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "shield_dome");
        setTranslationKey(Reference.MOD_ID + ".shield_dome");
        setHardness(-1.0F);
