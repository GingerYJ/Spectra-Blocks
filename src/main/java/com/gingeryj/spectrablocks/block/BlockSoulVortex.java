...
public class BlockSoulVortex extends Block {
    ...
    public BlockSoulVortex() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "soul_vortex");
        setTranslationKey(Reference.MOD_ID + ".soul_vortex");
        setHardness(-1.0F);
