...
public class BlockMagneticFluxCage extends Block {
    ...
    public BlockMagneticFluxCage() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "magnetic_flux_cage");
        setTranslationKey(Reference.MOD_ID + ".magnetic_flux_cage");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileMagneticFluxCage();
    }
