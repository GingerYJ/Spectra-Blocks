...
public class BlockFireflySwarm extends Block {
    ...
    public BlockFireflySwarm() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "firefly_swarm");
        setTranslationKey(Reference.MOD_ID + ".firefly_swarm");
        setHardness(-1.0F);
