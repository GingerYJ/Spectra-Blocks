...
public class BlockMicroWhiteHole extends Block {
    ...
    public BlockMicroWhiteHole() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "micro_white_hole");
        setTranslationKey(Reference.MOD_ID + ".micro_white_hole");
        setHardness(-1.0F);
