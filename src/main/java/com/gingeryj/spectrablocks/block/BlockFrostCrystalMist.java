...
public class BlockFrostCrystalMist extends Block {
    ...
    public BlockFrostCrystalMist() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "frost_crystal_mist");
        setTranslationKey(Reference.MOD_ID + ".frost_crystal_mist");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileFrostCrystalMist();
    }
