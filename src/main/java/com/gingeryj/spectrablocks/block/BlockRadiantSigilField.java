...
public class BlockRadiantSigilField extends Block {
    ...
    public BlockRadiantSigilField() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "radiant_sigil_field");
        setTranslationKey(Reference.MOD_ID + ".radiant_sigil_field");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileRadiantSigilField();
    }
