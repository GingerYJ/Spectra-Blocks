...
public class BlockChronoAnchor extends Block {
    ...
    public BlockChronoAnchor() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "chrono_anchor");
        setTranslationKey(Reference.MOD_ID + ".chrono_anchor");
        setHardness(-1.0F);
