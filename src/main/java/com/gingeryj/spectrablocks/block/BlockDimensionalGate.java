...
public class BlockDimensionalGate extends Block {
    ...
    public BlockDimensionalGate() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "dimensional_gate");
        setTranslationKey(Reference.MOD_ID + ".dimensional_gate");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileDimensionalGate();
    }
