...
public class BlockPollenBreeze extends Block {
    ...
    public BlockPollenBreeze() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "pollen_breeze");
        setTranslationKey(Reference.MOD_ID + ".pollen_breeze");
        setHardness(-1.0F);
