...
public class BlockCosmicBackgroundRadiationField extends Block {
    ...
    public BlockCosmicBackgroundRadiationField() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "cosmic_background_radiation_field");
        setTranslationKey(Reference.MOD_ID + ".cosmic_background_radiation_field");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileCosmicBackgroundRadiationField();
    }
