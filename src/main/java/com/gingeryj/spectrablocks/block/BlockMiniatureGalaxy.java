...
public class BlockMiniatureGalaxy extends Block {
    ...
    public BlockMiniatureGalaxy() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "miniature_galaxy");
        setTranslationKey(Reference.MOD_ID + ".miniature_galaxy");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileMiniatureGalaxy();
    }
