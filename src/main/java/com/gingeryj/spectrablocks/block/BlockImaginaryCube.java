...
public class BlockImaginaryCube extends Block {
    ...
    public BlockImaginaryCube() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "imaginary_cube");
        setTranslationKey(Reference.MOD_ID + ".imaginary_cube");
        setHardness(-1.0F);
