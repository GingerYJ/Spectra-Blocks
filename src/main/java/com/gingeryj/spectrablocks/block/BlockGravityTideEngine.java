...
public class BlockGravityTideEngine extends Block {
    ...
    public BlockGravityTideEngine() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "gravity_tide_engine");
        setTranslationKey(Reference.MOD_ID + ".gravity_tide_engine");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileGravityTideEngine();
    }
