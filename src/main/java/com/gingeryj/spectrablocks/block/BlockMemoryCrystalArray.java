...
public class BlockMemoryCrystalArray extends Block {
    ...
    public BlockMemoryCrystalArray() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "memory_crystal_array");
        setTranslationKey(Reference.MOD_ID + ".memory_crystal_array");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileMemoryCrystalArray();
    }
