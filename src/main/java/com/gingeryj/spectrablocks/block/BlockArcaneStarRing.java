...
public class BlockArcaneStarRing extends Block {
    ...
    public BlockArcaneStarRing() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "arcane_star_ring");
        setTranslationKey(Reference.MOD_ID + ".arcane_star_ring");
        setHardness(-1.0F);
