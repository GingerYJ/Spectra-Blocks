...
public class BlockMeteorShower extends Block {
    ...
    public BlockMeteorShower() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "meteor_shower");
        setTranslationKey(Reference.MOD_ID + ".meteor_shower");
        setHardness(-1.0F);
