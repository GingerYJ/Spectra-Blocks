...
public class BlockEtherReactorCore extends Block {
    ...
    public BlockEtherReactorCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "ether_reactor_core");
        setTranslationKey(Reference.MOD_ID + ".ether_reactor_core");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEtherReactorCore();
    }
