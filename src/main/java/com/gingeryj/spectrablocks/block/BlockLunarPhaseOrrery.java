...
public class BlockLunarPhaseOrrery extends Block {
    ...
    public BlockLunarPhaseOrrery() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "lunar_phase_orrery");
        setTranslationKey(Reference.MOD_ID + ".lunar_phase_orrery");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileLunarPhaseOrrery();
    }
