...
public class BlockChromaticVortex extends Block {
    ...
    public BlockChromaticVortex() {
        super(Material.GLASS);
        setRegistryName(Reference.MOD_ID, "chromatic_vortex");
        setTranslationKey(Reference.MOD_ID + ".chromatic_vortex");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileChromaticVortex();
    }
