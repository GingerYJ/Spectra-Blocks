...
public class BlockDataStreamMatrix extends Block {
    ...
    public BlockDataStreamMatrix() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "data_stream_matrix");
        setTranslationKey(Reference.MOD_ID + ".data_stream_matrix");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileDataStreamMatrix();
    }
