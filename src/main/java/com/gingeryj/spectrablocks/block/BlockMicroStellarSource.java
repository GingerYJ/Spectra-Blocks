...
public class BlockMicroStellarSource extends Block {
    ...
    public BlockMicroStellarSource() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "micro_stellar_source");
        setTranslationKey(Reference.MOD_ID + ".micro_stellar_source");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileMicroStellarSource();
    }
