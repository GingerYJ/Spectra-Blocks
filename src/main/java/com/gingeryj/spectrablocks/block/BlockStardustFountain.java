...
public class BlockStardustFountain extends Block {
    ...
    public BlockStardustFountain() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "stardust_fountain");
        setTranslationKey(Reference.MOD_ID + ".stardust_fountain");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileStardustFountain();
    }
