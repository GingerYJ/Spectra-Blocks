...
public class BlockSilentObelisk extends Block {
    ...
    public BlockSilentObelisk() {
        super(Material.ROCK);
        setRegistryName(Reference.MOD_ID, "silent_obelisk");
        setTranslationKey(Reference.MOD_ID + ".silent_obelisk");
        setHardness(-1.0F);
