...
public class BlockAstralAltarCore extends Block {
    ...
    public BlockAstralAltarCore() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "astral_altar_core");
        setTranslationKey(Reference.MOD_ID + ".astral_altar_core");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileAstralAltarCore();
    }
