...
public class BlockAlchemyTransmutationRing extends Block {
    ...
    public BlockAlchemyTransmutationRing() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "alchemy_transmutation_ring");
        setTranslationKey(Reference.MOD_ID + ".alchemy_transmutation_ring");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileAlchemyTransmutationRing();
    }
