...
public class BlockEnergyNexus extends Block {
    ...
    public BlockEnergyNexus() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "energy_nexus");
        setTranslationKey(Reference.MOD_ID + ".energy_nexus");
        setHardness(-1.0F);
