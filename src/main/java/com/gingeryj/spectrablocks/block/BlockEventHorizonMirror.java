...
public class BlockEventHorizonMirror extends Block {
    ...
    public BlockEventHorizonMirror() {
        super(Material.IRON);
        setRegistryName(Reference.MOD_ID, "event_horizon_mirror");
        setTranslationKey(Reference.MOD_ID + ".event_horizon_mirror");
        setHardness(-1.0F);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEventHorizonMirror();
    }
